...
<svg xmlns="http://www.w3.org/2000/svg" width="600" height="200">
  ...
  ${pill(42, 20, drugReady ? "Drug CD: READY" : `Drug CD: ${formatSeconds(drugSecs)}`, drugReady)}
  ${pill(42, 245, boosterReady ? "Booster CD: READY" : `Booster CD: ${formatSeconds(boosterSecs)}`, boosterReady)}
  ${pill(42, 470, refillAvailable ? `Refill: AVAILABLE (${REFILL_COST}pts)` : "Refill: USED TODAY", refillAvailable)}
